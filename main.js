...
function update() {
    ...
    if (menu == 'simulating') {
        ...
        team.forEach((e, i) => {
            ...
            while (((e.y > prey + Math.sin(angle) && Math.sin(angle) > 0) || (e.y < prey + Math.sin(angle) && Math.sin(angle) < 0)) && enemieTeam.some(o => o.x + 64 > e.x && o.x < e.x + 64 && o.y + 64 > e.y && o.y < e.y + 64)) {
                e.y -= Math.sin(angle)
            }
            ...
            try {
                if (enemieTeam[e.focus].x + 64 > e.x && enemieTeam[e.focus].x < e.x + 64 && enemieTeam[e.focus].y + 64 > e.y && enemieTeam[e.focus].y < e.y + 64) {
                    ...
                    enemieTeam[e.focus].y += Math.sin(angle) * 2 * (speeds[e.weight]) * 70 * recoils[e.weight]
        ...
        enemieTeam.forEach((e, i) => {
            ...
            try {
                if (team[e.focus].x + 64 > e.x && team[e.focus].x < e.x + 64 && team[e.focus].y + 64 > e.y && team[e.focus].y < e.y + 64) {
                    team[e.focus].x += Math.cos(angle) * 2 * (speeds[e.weight]) * 70* recoils[e.weight]
                    while (team[e.focus].x < 64 || team[e.focus].x > canvas.width - 64) {
                        team[e.focus].x -= Math.cos(angle)
                    }
                    team[e.focus].y += Math.sin(angle) * 2 * (speeds[e.weight]) * 70 * recoils[e.weight]
